...
from MpesaViews.mpesa import MobileMoneyPayment, SendSTKPushView, MpesaCallbackView
...
urlpatterns = [
    ...
    path("mpesa/callback/", MpesaCallbackView.as_view(), name="callback"),
    path("mpesa/stk/", SendSTKPushView.as_view(), name="stk"),
